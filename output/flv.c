...
static int write_headers( hnd_t handle, x264_nal_t *p_nal )
{
    ...
    if( sps[1] == 100 || sps[1] == 110 || sps[1] == 122 || sps[1] == 144 )
    {
        ...
        x264_put_byte( c, (BIT_DEPTH-8) | 0xf8 );   // 5 bits reserved (11111) + 3 bits bit depth of the samples in the luma arrays
        x264_put_byte( c, (BIT_DEPTH-8) | 0xf8 );   // 5 bits reserved (11111) + 3 bits bit depth of the samples in the chroma arrays
